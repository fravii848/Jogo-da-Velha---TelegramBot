...
class Velhus:
    """
    simulador dos traços; permite calcular as jogas possíveis jogadas.

    Estado = grelha como uma lista de strings.
    Espaço = null/que a posição está livre.
...
TOKEN = os.getenv("900184140:AAHGjLCohIBIWRUVYzoKBKdA7IH3zWNw8T0")
